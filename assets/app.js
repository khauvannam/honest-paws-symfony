...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let totalPriceValue = parseFloat(totalPriceElement.textContent.replace(/\s|\$/g, ""));
    ...
    function attachButtonClickEvent(button, change) {
        button.addEventListener('click', function () {
            ...
            const priceChange = updateQuantity(change, totalItemPriceElement, quantityInput);

            if (priceChange !== 0) { // Update only if there is a price change
