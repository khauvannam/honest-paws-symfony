 ...
 */
final class Version20240809123947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD avatar_link VARCHAR(180) NOT NULL, ADD user_verify VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP avatar_link, DROP user_verify');
    }
}
